...
/**
 * WorkAppUserProfilePage is an instance of IPage interface, which models the user through a digital profile
 * @author dhgovindaraj
 *
 */
public class WorkAppUserProfilePage implements IPage
{
	...
	public synchronized static void createNewPage(Object userID)
	{
	...
	public synchronized static Object loadSection(Object userID, Object name)
	{
		return null;
	}
	
	public synchronized static void editProfilePic()
	{
		
	}
	
	public synchronized static void editBasicInfo()
	{
	...
	public synchronized static void AddToTrustList(Object id)
	{
		
	}

	public synchronized static void AddToSkillList(Object id)
	{
