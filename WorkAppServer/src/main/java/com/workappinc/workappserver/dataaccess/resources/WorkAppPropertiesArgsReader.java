...
/**
 * WorkAppPropertiesReader implements IReader interface which is used to read Properties object (which is used as a second pass when reading config from File) and store it as Arguments in the Server
 * @author dhgovindaraj
 *
 */
