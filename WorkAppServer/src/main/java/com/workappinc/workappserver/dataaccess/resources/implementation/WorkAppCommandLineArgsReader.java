 ...
 * read Command-Line object and store it as Arguments in the Server
 * 
 * @author dhgovindaraj
 *
 */
public class WorkAppCommandLineArgsReader implements IReader
{

	/**
	 * A convenience method for parsing and automatically producing error
	 * messages.
	 *
	 * @param target
	...
	public static List<String> parseOrExit(Object target, String[] args)
	{
		...
		catch (IllegalArgumentException e)
		{
			...
			WorkAppCommandLineArgsReader.usage(target);
			System.exit(1);
			throw e;
		}
	}
	 ...
	 *
	 * @param errStream
	 *            A {@link java.io.PrintStream} to print the usage information
	 *            to.
	 * @param target
	 *            An instance or class.
	 */
	...
	static String getName(WorkAppArgument argument, PropertyDescriptor property)
	{
	...
	private static Object consumeArgumentValue(Class<?> type, WorkAppArgument argument, Iterator<String> i)
	{
		Object value;
		if (type == Boolean.TYPE || type == Boolean.class)
		{
	...
	static String getAlias(WorkAppArgument argument)
	{
	...
	static String getName(WorkAppArgument argument, Field field)
	{
		String name = argument.value();
		if (name.equals(""))
		{
	...
	{
		/**
		 * Creates a value object of the given type using the given string value
		 * representation;
		 *
		 * @param type
		 *            the type to create an instance of
		 * @param value
		 *            the string represented value of the object to create
	...
	/**
	 * Creates a {@link ValueCreator} object able to create object assignable
	 * from given type, using a static one arg method which name is the the
	 * given one taking a String object as parameter
	 *
	 * @param compatibleType
	 *            the base assignable for which this object will try to invoke
	 *            the given method
	 * @param methodName
	 *            the name of the one arg method taking a String as parameter
	 *            that will be used to built a new value
	 * @return null if the object could not be created, the value otherwise
	 */
	...
	/**
	 * {@link ValueCreator} building object using a one arg constructor taking a
	 * {@link String} object as parameter
	 */
	...
	public static final ValueCreator ENUM_CREATOR = new ValueCreator()
	{
		...
		public Object createValue(Class type, String value)
		{
			if (Enum.class.isAssignableFrom(type)) { return Enum.valueOf(type, value); }
			return null;
		}
	};
	 ...
	 *
	 * @param vc
	 *            another value creator to take into account for trying to
	 *            create values
	 */
