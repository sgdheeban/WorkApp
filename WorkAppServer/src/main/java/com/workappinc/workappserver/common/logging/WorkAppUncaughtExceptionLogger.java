...
/**
 * WorkAppUncaughtException handler is a background thread, that handles any fatal, uncaught exceptions
 * @author dhgovindaraj
 *
 */
	  ...
	  public static void setDefaultUncaughtExceptionHandler() {
		    Thread.setDefaultUncaughtExceptionHandler(new Thread.UncaughtExceptionHandler() {
		      ...
		      public void uncaughtException(final Thread th, final Throwable t) {
		        WorkAppLogger.getInstance().LogError(new WorkAppUncaughtException("Uncaught exception in thread " + th, t),this.getClass());
		      }
		    });
		  }
}
