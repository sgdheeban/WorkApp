...
public interface ICounter
{
	 ...
	 * 
	 * (1) Transaction Time per API, per Machine, Per Pool (2) Transaction per
	 * Second per Machine, Per Pool (3) Exception Count per Machine, Per Pool
	 * (4) CPU Usage per Machine, Per Pool (5) JVM Memory Usage per Machine, Per
	 * Pool (6) GC Overhead Per Machine, Per Pool
	 * 
	 */
