...
public final class Log
{
	...
	public static final String ENGINE = "orm.engine";
	public static final String PROFILING = "orm.profiling";
	public static final String RESULTS = "orm.results";
	public static final String PARAMETERS = "orm.parameters";
