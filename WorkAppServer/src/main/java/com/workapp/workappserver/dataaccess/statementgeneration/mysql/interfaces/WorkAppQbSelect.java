 ...
 * @author dhgovindaraj
 */
public interface WorkAppQbSelect extends WorkAppQbQuery
{
	/**
	...
	{
		LEFT, RIGHT, OUTER, INNER, LEFT_OUTER, RIGHT_OUTER, DEFAULT
	}
	...
	/**
	 * Similar to
	 * {@link #join(String, WorkAppQbField, WorkAppQbField, QbJoinType) join}
	 ...
	 * 
	 * @param offset
	 *            - The record offset, starting at zero.
	 * @param count
