package com.workapp.workappserver.dataaccess.orm.core;
...
public abstract class Mapping
{
	...
	public static final Mapping getMapping(final DatabaseMetaData metaData, final Class objectClass, final NameGuesser nameGuesser)
	{
		...
		final com.workapp.workappserver.dataaccess.orm.annotations.NoTable noTableAnnotation = (com.workapp.workappserver.dataaccess.orm.annotations.NoTable) objectClass.getAnnotation(com.workapp.workappserver.dataaccess.orm.annotations.NoTable.class);
	...
	protected static final Map[] getFieldsMaps(final Class objectClass)
	{
		...
		final Map<String, com.workapp.workappserver.dataaccess.orm.annotations.Column> annotationsMap = new HashMap();
		...
		for (String suffix : allMethods.keySet())
		{
			...
			if (getterSetter[0] != null && getterSetter[1] != null)
			{
				...
				// column annotation
				final com.workapp.workappserver.dataaccess.orm.annotations.Column getterAnnotation = getterSetter[0].getAnnotation(com.workapp.workappserver.dataaccess.orm.annotations.Column.class);
				final com.workapp.workappserver.dataaccess.orm.annotations.Column setterAnnotation = getterSetter[1].getAnnotation(com.workapp.workappserver.dataaccess.orm.annotations.Column.class);

				// if NoColumn is specified, don't use the field
				final com.workapp.workappserver.dataaccess.orm.annotations.NoColumn noPersistGetter = getterSetter[0].getAnnotation(com.workapp.workappserver.dataaccess.orm.annotations.NoColumn.class);

				final com.workapp.workappserver.dataaccess.orm.annotations.NoColumn noPersistSetter = getterSetter[1].getAnnotation(com.workapp.workappserver.dataaccess.orm.annotations.NoColumn.class);
				...
				com.workapp.workappserver.dataaccess.orm.annotations.Column annotation = null;
