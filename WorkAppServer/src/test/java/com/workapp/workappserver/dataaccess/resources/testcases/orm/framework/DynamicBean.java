package com.workapp.workappserver.dataaccess.resources.testcases.orm.framework;
...
public class DynamicBean
{
	...
	public static Class createBeanClass(BeanMap beanMap, boolean noTable)
	{
		...
		CtClass cc = pool.makeClass("com.workapp.workappserver.dataaccess.resources.testcases.orm.framework." + beanMap.getClassName() + (noTable ? "NoTable" : ""));
		...
		if (noTable)
		{
			...
			try
			{
				a = new Annotation(cp, pool.get("com.workapp.workappserver.dataaccess.orm.annotations.NoTable"));
			}
		...
		try
		{
			...
			String toStringCode = "public String toString() { return com.workapp.workappserver.dataaccess.resources.testcases.orm.framework.DynamicBean.toString(this); }";
			CtMethod cm = CtNewMethod.make(toStringCode, cc);
			cc.addMethod(cm);

			String equalsCode = "public boolean equals(Object obj) { return com.workapp.workappserver.dataaccess.resources.testcases.orm.framework.DynamicBean.compareBeans(this,obj); }";
	...
	/**
	 * Returns true if the field is a primitive number type (byte, short, int,
	 * etc.) and its value is zero, or if the field is an object and its value
	 * is null
	 */
	...
	public static boolean compareValues(Object v1, Object v2)
	{
		...
		try
		{
			...
			else if (type == java.sql.Timestamp.class)
			{
				...
				// quick fix for smalldatetimes is to compare up to 15, instead
				// of 19
	...
	/**
	 * Try to convert the provided object to the provided class. The following
	 * groups of types allow for conversion among their types: { String, char,
	 * Character, char[], Character[], Reader } { byte[], Byte[], InputStream }
	 * { boolean, Boolean } { byte, Byte, short, Short, int, Integer, long,
	 * Long, float, Float, double, Double, BigDecimal } { java.sql.Timestamp,
	 * java.sql.Date, java.sql.Time, java.util.Date }
	 */
	public static Object convertToType(Class cls, Object value)
	{
		...
		if (cls == String.class || cls == char.class || cls == Character.class || cls == char[].class || cls == Character[].class || cls == Reader.class || cls == Clob.class)
		{
			...
			else if (cls == Clob.class) { return new StringClob(s); }
		}
		...
		else if (cls == byte[].class || cls == Byte[].class || cls == InputStream.class || cls == Blob.class)
		{
			...
			else if (cls == Blob.class) { return new BytesBlob(a); }
		}

		else if (clsValue == java.util.Date.class)
		{
			java.util.Date d = (java.util.Date) value;
			if (cls == java.sql.Date.class) { return new java.sql.Date(d.getTime()); }
			if (cls == java.sql.Time.class) { return new java.sql.Time(d.getTime()); }
		...
		{
			if (clsValue == java.sql.Date.class) { return new java.util.Date(((java.sql.Date) value).getTime()); }
			if (clsValue == java.sql.Time.class) { return new java.util.Date(((java.util.Date) value).getTime()); }
