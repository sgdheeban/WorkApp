package com.workapp.workappserver.dataaccess.resources.testcases.orm.mysql;
...
import com.workapp.workappserver.dataaccess.resources.testcases.orm.common.TestSimple;
import com.workapp.workappserver.dataaccess.resources.testcases.orm.framework.BeanMap;
import com.workapp.workappserver.dataaccess.resources.testcases.orm.framework.BeanTest;
import com.workapp.workappserver.dataaccess.resources.testcases.orm.framework.FieldMap;
...
public class WorkAppOrmMySQLTestCase extends TestSimple
{
	...
	public void testStringTypes() throws SQLException
	{
		...
		Class[] characterTypes = new Class[]
		{
				Character.class, char.class, String.class
		};
		Class[] stringTypes = new Class[]
		{
				String.class, char[].class, Character[].class
		};
		Class[] clobTypes = new Class[]
		{
	...
	public void testNumericTypes() throws SQLException
	{
		...
		Class[] integerTypes = new Class[]
		{
				Integer.class, int.class
		};
		Class[] booleanTypes = new Class[]
		{
				Boolean.class, boolean.class
		};
		Class[] byteTypes = new Class[]
		{
				Byte.class, byte.class
		};
		Class[] shortTypes = new Class[]
		{
				Short.class, short.class
		};
		Class[] longTypes = new Class[]
		{
				Long.class, long.class
		};
		Class[] doubleTypes = new Class[]
		{
