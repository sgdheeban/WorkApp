...
public class DynamicBean
{
	...
	public static Class createBeanClass(BeanMap beanMap, boolean noTable)
	{
		...
		if (noTable)
		{
			...
			try
			{
				a = new Annotation(cp, pool.get("com.workappinc.workappserver.dataaccess.orm.annotations.NoTable"));
			}
		...
		try
		{
			...
			String toStringCode = "public String toString() { return com.workappinc.workappserver.dataaccess.resources.testcases.orm.framework.DynamicBean.toString(this); }";
			CtMethod cm = CtNewMethod.make(toStringCode, cc);
			cc.addMethod(cm);

			String equalsCode = "public boolean equals(Object obj) { return com.workappinc.workappserver.dataaccess.resources.testcases.orm.framework.DynamicBean.compareBeans(this,obj); }";
