...
public class WorkAppArgReaderTest {
	...
	public void testArgsParse() {
        ...
        String[] args = {"-input", "inputfile", "-o", "outputfile", "extra1", "extra2", "-someflag", "-m", "10", "-values", "1:2:3", "-strings", "sam;dave;jolly"};
    ...
    public void testMultipleArgs() {
      TestCommand tc = new TestCommand();
      WorkAppCommandLineArgsReader.usage(tc);
      String[] args = {"-input", "inputfile", "-o", "outputfile", "-someflag", "-m", "10", "extra1", "extra2", "-values", "1", "-values", "2", "-values", "3", "-strings", "sam", "-strings", "dave", "-strings", "jolly"};
      List<String> extra = WorkAppCommandLineArgsReader.parse(tc, args);
      assertEquals("inputfile", tc.inputFilename);
      assertEquals(new File("outputfile"), tc.outputFile);
      assertEquals(true, tc.someflag);
